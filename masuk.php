    ...
    Tambah Barang
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php
                                    $ambilsemuadatastock = mysqli_query($conn,"select * from stock m, stock s where s.idbarang=m.idbarang");
                            ...
                            <div class="modal fade" id="edit<?=$idb;?>">
                                ...
                                <div class="modal-content">
                                    ...
                                    <nput type="hidden" name="idm" value="<?=$idm;?>">
                                    <button type="sumit" class="btn btn.primary" name="updatebarangmasuk">Submit</button>
                                    </div>
                                    </from>
                                </div>
                                </div>
                             ...
                             <div class="modal fade" id="delete<?=$idb;?>">
                                ...
                                <div class="modal-content">
                                    ...
                                    <nput type="hidden" name="idb" value="<?=$idb;?>">
                                    <nput type="hidden" name="qty" value="<?=$qty;?>">
                                    <br>
                                    <br>
                                    <button type="sumit" class="btn btn.denger" name="hapusbarangmasuk">Submit</button>
                                    </div>
                                    </from>
                                </div>
                                </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <br>
          ...
          <br>
          <input type ="text" name="penerima" class="from-control" placeholder="Penerima">required>
          <br>
